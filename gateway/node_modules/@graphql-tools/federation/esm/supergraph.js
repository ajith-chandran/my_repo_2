...
import { defaultMergedResolver, delegateToSchema, extractUnavailableFieldsFromSelectionSet, subtractSelectionSets, } from '@graphql-tools/delegate';
...
export function getStitchedSchemaFromSupergraphSdl(opts) {
    ...
    return filterInternalFieldsAndTypes(mergeSchemas({
